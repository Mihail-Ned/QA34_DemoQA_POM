...
public class PracticeFormPage extends BasePage {
    ...
    WebElement statelnput;

    public PracticeFormPage selectState(String state) {
        click(stateContainer);//если экран монитора большой можно выбирать этот вариант
//        clickWithJS(stateContainer, 0, 200);//если экран монитора маленький выбирать этот вариант
        statelnput.sendKeys(state);
        statelnput.sendKeys(Keys.ENTER);
        return this;
    }
    ...
    WebElement citylnput;

    public PracticeFormPage selectCity(String city) {
        click(cityContainer);
        citylnput.sendKeys(city);
        citylnput.sendKeys(Keys.ENTER);
        return this;
    }
